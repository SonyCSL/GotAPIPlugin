...
public class KadecotDeviceService extends DConnectMessageService {
    ...
    private Application mApp ;  // SonyCSL : KadecotDeviceApplication implementations are at the end of this class
    /** Logger. */
    ...
    public void onCreate() {
        ...
        KadecotDeviceApplication_onCreate() ;
    }
                ...
                try {
                    ...
                    for (JSONObject obj : kadecotObject) {
                        ...
                        if (kadecotDevice.getStatus().equals("true")
                            ...
                            String serviceId = "";
                            ENLObject object = KadecotDeviceApplication_getENLObject();
    ...
    private void KadecotDeviceApplication_onCreate() {
     ...
     */
    public ENLObject KadecotDeviceApplication_getENLObject() {
        return mObject;
    }
